...
public class MainActivity extends Activity {
   ...
   // private final String subscriptionKey = System.getenv("FACE_SUBSCRIPTION_KEY");
    ...
    private final FaceServiceClient faceServiceClient =
            new FaceServiceRestClient("https://francecentral.api.cognitive.microsoft.com/face/v1.0/detect?", "4136e287e0b44a5e8b7a252876e75d69");
        ...
        AsyncTask<InputStream, String, Face[]> detectTask =
                new AsyncTask<InputStream, String, Face[]>() {
                    ...
                    protected void onPostExecute(Face[] result) {
                        ...
                        textView.setText("ona ma: "+writeEmotions(result)+" lat");
                    }
                };
    ...
    private static double writeEmotions(Face[] faces) {
        double faceAge = 0;
        if (faces != null) {
            for (Face face : faces) {
                FaceRectangle faceRectangle = face.faceRectangle;
                faceAge = face.faceAttributes.age;
            }
